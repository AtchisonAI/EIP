...
{
    public class WorkflowProcessInstanceActivityRepository : WorkFlowBaseRepository<WorkflowProcessInstanceActivity>, IWorkflowProcessInstanceActivityRepository
    {
        /// <summary>
        ///     获取下一步流程信息
        /// </summary>
