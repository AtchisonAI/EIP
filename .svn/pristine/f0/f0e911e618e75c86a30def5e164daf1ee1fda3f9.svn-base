   ...
   var $grid = $("#list").jgridview(
        {
            ...
            colModel: [
                {
                    label: "Type", name: "COL", width: 143, fixed: true, frozen: true ,
                    cellattr: function (rowId, val, rawObject, cm, rdata) {
                        //判断是否符合条件
                        return " style='color:green;font-weight:bold;'";
                    }
                },
                { label: "Jan", name: "C01", width: 85, fixed: true },
                { label: "Feb", name: "C02", width: 85, fixed: true },
                { label: "Mar", name: "C03", width: 85, fixed: true },
                { label: "Apr", name: "C04", width: 85, fixed: true },
                { label: "May", name: "C05", width: 85, fixed: true },
                { label: "Jun", name: "C06", width: 85, fixed: true },
                { label: "Jul", name: "C07", width: 85, fixed: true },
                { label: "Aug", name: "C08", width: 85, fixed: true },
                { label: "Sep", name: "C09", width: 85, fixed: true },
                { label: "Oct", name: "C10", width: 85, fixed: true },
                { label: "Nov", name: "C11", width: 85, fixed: true },
                { label: "Dec", name: "C12", width: 85, fixed: true }
