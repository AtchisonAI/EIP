...
function getGridData() {
    UtilAjaxPost("/Quartz/Quartz/GetCalendar", {}, function (data) {
...
//操作:新增
function add() {
    ArtDialogOpen("/Quartz/Quartz/CalendarEdit", "新增日历配置", true, 310, 580);
}
...
function edit() {
    ...
    GridIsSelect($grid, function () {
        ...
        ArtDialogOpen("/Quartz/Quartz/CalendarEdit?calendarName=" + info.CalendarName, "修改日历配置-" + info.CalendarName, true, 310, 580);
    });
}
