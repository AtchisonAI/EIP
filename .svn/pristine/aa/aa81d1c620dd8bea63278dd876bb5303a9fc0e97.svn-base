...
function formSubmit() {
    //选中行数据
    art.dialog.data("cronObj", $("#cron").val());
...
function initEvent() {
    ...
    cron.change(function () {
        btnFan();
        //设置最近五次运行时间
        UtilAjaxPost("/Quartz/Quartz/CalcRunTime", { cronExpression: $("#cron").val() }, function (data) {
    ...
    secondList.change(function () {
        var sencondAppoint = $("#sencond_appoint").prop("checked");
        if (sencondAppoint) {
            var vals = [];
    ...
    minList.change(function () {
        var minAppoint = $("#min_appoint").prop("checked");
        if (minAppoint) {
            var vals = [];
    ...
    hourList.change(function () {
        var hourAppoint = $("#hour_appoint").prop("checked");
        if (hourAppoint) {
            var vals = [];
    ...
    dayList.change(function () {
        var dayAppoint = $("#day_appoint").prop("checked");
        if (dayAppoint) {
            var vals = [];
    ...
    mouthList.change(function () {
        var mouthAppoint = $("#mouth_appoint").prop("checked");
        if (mouthAppoint) {
            var vals = [];
    ...
    weekList.change(function () {
        var weekAppoint = $("#week_appoint").prop("checked");
        if (weekAppoint) {
            var vals = [];
