...
//配置项
var requireConfig = {
    urlArgs: 'v=1.2.13',//版本号
    //加载需要在框架使用的文件
    paths: {
        jquery: 'lib/jquery-1.9.1.min',//引入jquery
        bootstrap: 'lib/bootstrap/bootstrap.min',//引入bootstrap
        echarts: 'lib/echarts/echarts.min',//引入echarts
        select2: 'lib/select2/js/select2.full.min',//引入select2
        select2en: 'lib/select2/js/i18n/en',//引入i18n  EN语言包
        select2zhcn: 'lib/select2/js/i18n/zh-CN',//引入i18n 简体中文语言包
        select2twcn: 'lib/select2/js/i18n/zh-TW',//引入i18n 繁体中文语言包
        ...
        reportingListview: 'app/reporting/reportingListview',
        ...
        list: 'app/list', //列表
        edit: 'app/edit',//编辑
        reporting: 'app/reporting/reporting', //Reporting
        reportingbootstrap: 'app/reporting/reportingbootstrap', //reportingbootstrap
    ...
    shim: {
        ...
        select2: {
            deps: ['css!lib/select2/css/select2.min.css', 'css!lib/select2/css/select2-bootstrap.min.css', 'jquery']
        },
        echarts: {
            deps: ['css!../Contents/analysis/css/css.css', 'jquery']
        },
        bootstrap: {
            deps: ['css!lib/bootstrap/bootstrap.min.css', 'jquery']
        },
        //弹出框
        artdialog: {
