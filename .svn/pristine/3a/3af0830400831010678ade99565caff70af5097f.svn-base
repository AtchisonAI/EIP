...
namespace EIP.Common.Web
{
    ...
    public class BaseController : Controller
    {
        ...
        protected override void OnException(ExceptionContext filterContext)
        {
            ...
            if(filterContext.Exception is ParameterRequiredException)
                errorRoute.Values.Add("msg", filterContext.Exception);
            else
                errorRoute.Values.Add("msg", filterContext.Exception.Message);
            errorController.Execute(new RequestContext(HttpContext, errorRoute));
        ...
        /// <returns></returns>
        protected JsonResult JsonForGridPaging(PagedResults pagedResults)
        {
            return new JsonResultExtension
            {
                Data =
