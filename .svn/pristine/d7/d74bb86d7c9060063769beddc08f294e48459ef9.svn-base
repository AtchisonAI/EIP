...
function getGridData() {
    UtilAjaxPost("/Quartz/Quartz/GetAllJobs", {}, function (data) {
...
//操作:新增
function add() {
    ArtDialogOpen("/Quartz/Quartz/JobEdit", "新增调度作业配置", true, 580, 680);
}
...
function edit() {
    ...
    GridIsSelect($grid, function () {
        ...
        ArtDialogOpen("/Quartz/Quartz/JobEdit?edit=1&"
