...
define([], function () {
    return {
        ...
        'system-quartz-quartzlist': 'app/quartz/quartzlist', //作业列表
        'system-quartz-quartzedit': 'app/quartz/quartzedit', //作业编辑
        'system-quartz-cron': 'app/quartz/cron', //作业编辑
        'system-quartz-calendarlist': 'app/quartz/calendarlist', //排除日历列表
        'system-quartz-calendaredit': 'app/quartz/calendaredit', //排除日历编辑

        'reporting-demo-multireleaselot': 'app/Reporting/MultiReleaseLot/multireleaselot',//下载编辑
        'reporting-demo-releaselots': 'app/Reporting/MultiReleaseLot/releaselots',//下载编辑
        'reporting-jason-product': 'app/Reporting/ProductInfo/ProductInfo',//下载编辑
        'reporting-xutao-querylotinfo': 'app/Reporting/XuTao/XuTao',
        'reporting-xutao-querylothistory': 'app/Reporting/XuTao/LotHistory',
        'reporting-employinfo': 'app/Reporting/EmployInfo/EmployInfo',//人员信息列表
        'reporting-demo-Viewlotstatus': 'app/Reporting/LwfTest/LwfTest',
        'reporting-wipmovereport-queryinfo': 'app/Reporting/WIPMoveReport/WIPMoveReport',
        'reporting-holdwipreport-querylotdetail': 'app/Reporting/HoldWIPReport/Detail',
        'reporting-holdwipreport-querywipholdinfo': 'app/Reporting/HoldWIPReport/WIPHold',
        'reporting-zhanglu-QueryLotHistoryInfo': 'app/Reporting/LotHistory/LotHistory',
        'reporting-zhanglu-QueryLotHoldHistoryInfo': 'app/Reporting/LotHistory/LotHoldHistory',
        'reporting-eqpstatusmonitor-eqpstatusmonitor': 'app/Reporting/EQPStatusMonitor/EQPStatusMonitor',
        'reporting-EAPUpTimeReport-Query': 'app/Reporting/EAPUpTimeRPT/EAPUpTimeRPT',//add by luwf at 2018/8
        'reporting-ProductIndices-queryinfo': 'app/Reporting/ProductIndices/ProductIndices',
        'reporting-ProductIndices-queryStartDetails': 'app/Reporting/ProductIndices/StartDetails',
        'reporting-ProductIndices-queryScrapDetails': 'app/Reporting/ProductIndices/ScrapDetails',
        'reporting-ProductIndices-queryUnscrapDetails': 'app/Reporting/ProductIndices/UnscrapDetails',
        'reporting-ProductIndices-queryHoldDetails': 'app/Reporting/ProductIndices/HoldDetails',
        'reporting-ProductIndices-queryReworkDetails': 'app/Reporting/ProductIndices/ReworkDetails',
        'reporting-coder-holdlothistory': 'app/Reporting/HoldLotHistory/HoldLotHistory',
        'reporting-coder-holdlothistorydetailinfo': 'app/Reporting/HoldLotHistory/HoldLotHistoryDetail',
        'reporting-coder-eqpdaliyreport': 'app/Reporting/EQPDaliyReport/EQPDaliyReport',
        'reporting-WIPWaferInOut-Query': 'app/Reporting/WIPWaferInOut/WIPWaferInOut',//add by luwf at 2018/8
        'reporting-Scrap-Summaryscrap': 'app/Reporting/Scrap/ScrapReport',
        'reporting-WIPProfile-WIPProfile': 'app/Reporting/WIPProfile/WIPProfile',
        'reporting-LotForecast-LotForecast': 'app/Reporting/WIPProfile/LotForecast',
        'reporting-WaferInOut-WaferInOutDetails': 'app/Reporting/WIPWaferInOut/WaferInOutDetails',//add by luwf at 2018/8
        'reporting-eqpgroupperformance-eqpgroupperformance': 'app/Reporting/EQPGroupPerformance/EQPGroupPerformance', //add by Jason at 2018/8
        'reporting-eqpgroupperformance-QueryEQPGroupWipDetail': 'app/Reporting/EQPGroupPerformance/WipDetail', //add by Jason at 2018/8
        'reporting-eqpgroupperformance-QueryEQPGroupMoveDetail': 'app/Reporting/EQPGroupPerformance/MoveDetail', //add by Jason at 2018/8
        'reporting-eqpgroupperformance-QueryEQPGroupWipMoveDetail': 'app/Reporting/EQPGroupPerformance/WipMoveDetail', //add by Jason at 2018/8


        'reporting-WIPStatus-QueryWIPStatus': 'app/Reporting/WIPStatus/WIPStatus',
        'reporting-URDDueDate-URDDueDate': 'app/Reporting/URD_DueDate/URD_DueDate',

        'rpt-tbljobconfig-list': 'app/Reporting/jobconfig/list',//下载列表
        'rpt-tbljobconfig-edit': 'app/Reporting/jobconfig/edit'//下载编辑
        



        //工作流  暂时删除  2018.05.20 徐涛
