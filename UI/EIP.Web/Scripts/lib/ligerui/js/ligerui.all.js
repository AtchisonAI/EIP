    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        _fillGridBody: function (data, frozen,sourceType)
        {
            var g = this, p = this.options;
            //加载数据 
            var gridhtmlarr = sourceType == "scroll" ? [] : ['<div class="l-grid-body-inner"><table class="l-grid-body-table" cellpadding=0 cellspacing=0><tbody>'];
        ...
        _setEvent: function ()
        {
            ...
            g.gridbody.bind('scroll.grid', function ()
            {
                ...
                if (p.scrollToPage && p.usePager && p.newPage != p.pageCount && !g.loading)
                {
