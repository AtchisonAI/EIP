...
using EIP.Common.Core.DataBase;
...
{
    public class SystemDataBaseBackUpLogic : AsyncLogic<SystemDataBaseBackUp>, ISystemDataBaseBackUpLogic
    {
        #region 构造函数
        ...
        public async Task<OperateStatus> SystemDataBaseBackUp(SystemDataBaseBackUpDoubleWay doubleWay)
        {
            ...
            string bakPath = "\\DataUsers\\DataBaseBackUps\\" + systemDataBase.Name + DateTime.Now.ToString("yyyyMMddhhssmm") + ".bak";
            //开始进行数据库备份操作
